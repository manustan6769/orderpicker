        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Are you sure you want to delete <strong>{selected.size}</strong> selected order{selected.size !== 1 ? 's' : ''}? This action cannot be undone and will permanently remove the order{selected.size !== 1 ? 's' : ''} and all associated positions from the database.
            </p>
